...
# Directories
train_path = '/media/samir/Secondary/Voice Separation/U-Net/training/mix/'
model_path = '/media/samir/Secondary/Voice Separation/U-Net/models'
model_name = 'UNet_Default_DSD100'
